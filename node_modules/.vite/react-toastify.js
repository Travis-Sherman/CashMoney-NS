...
var C = { list: new Map(), emitQueue: new Map(), on(e2, t2) {
...
function O(e2) {
  const [, o2] = (0, import_react.useReducer)((e3) => e3 + 1, 0), [c2, l] = (0, import_react.useState)([]), h2 = (0, import_react.useRef)(null), T2 = (0, import_react.useRef)(new Map()).current, v2 = (e3) => c2.indexOf(e3) !== -1, E2 = (0, import_react.useRef)({ toastKey: 1, displayedToast: 0, count: 0, queue: [], props: e2, containerId: null, isToastActive: v2, getToast: (e3) => T2.get(e3) }).current;
  function _2(e3) {
  ...
  return (0, import_react.useEffect)(() => (E2.containerId = e2.containerId, C.cancelEmit(3).on(0, N2).on(1, (e3) => h2.current && O2(e3)).on(5, _2).emit(2, E2), () => C.emit(3, E2)), []), (0, import_react.useEffect)(() => {
    ...
    const n2 = new Map(), o3 = Array.from(T2.values());
